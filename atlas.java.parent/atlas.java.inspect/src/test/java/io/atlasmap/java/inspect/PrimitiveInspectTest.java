...
public class PrimitiveInspectTest {
	...
	public void testPrimitiveArrays() throws Exception {
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(boolean[].class), "boolean", 1);
		...
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(double[].class), "double", 1);
	...
	public void testPrimitiveTwoDimArrays() throws Exception {
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(boolean[][].class), "boolean", 2);
		...
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(double[][].class), "double", 2);
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(float[][].class), "float", 2);
		...
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(short[][].class), "short", 2);
	}
	
	@Test
	public void testPrimitiveThreeDimArrays() throws Exception {
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(boolean[][][].class), "boolean", 3);
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(byte[][][].class), "byte", 3);
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(char[][][].class), "char", 3);
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(double[][][].class), "double", 3);
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(float[][][].class), "float", 3);
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(int[][][].class), "int", 3);
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(long[][][].class), "long", 3);
		PrimitiveValidationUtil.validatePrimitiveArray(classInspectionService.inspectClass(short[][][].class), "short", 3);
	}
}
