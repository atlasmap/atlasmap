...
public class StringComplexFieldActions implements AtlasFieldAction {
    ...
    public static String padStringRight(Action action, String input) {
        ...
        if(action == null || !(action instanceof PadStringRight) || 
           ((PadStringRight)action).getPadCharacter() == null || ((PadStringRight)action).getPadCount() == null) {
    ...
    public static String padStringLeft(Action action, String input) {
        ...
        if(action == null || !(action instanceof PadStringLeft) || 
           ((PadStringLeft)action).getPadCharacter() == null || ((PadStringLeft)action).getPadCount() == null) {
    ...
    public static String subString(Action action, String input) {
        ...
        if(action == null || !(action instanceof SubString) || ((SubString)action).getStartIndex() == null || ((SubString)action).getStartIndex() < 0) {
    ...
    public static String subStringAfter(Action action, String input) {
        ...
        if(action == null || !(action instanceof SubStringAfter) || ((SubStringAfter)action).getStartIndex() == null || ((SubStringAfter)action).getStartIndex() < 0 
           || ((SubStringAfter)action).getMatch() == null || (((SubStringAfter)action).getEndIndex() != null && ((SubStringAfter)action).getEndIndex() > ((SubStringAfter)action).getStartIndex())) {
    ...
    public static String subStringBefore(Action action, String input) {
        ...
        if(action == null || !(action instanceof SubStringBefore) || ((SubStringBefore)action).getStartIndex() == null || ((SubStringBefore)action).getStartIndex() < 0 
                || ((SubStringBefore)action).getMatch() == null || (((SubStringBefore)action).getEndIndex() != null && ((SubStringBefore)action).getEndIndex() > ((SubStringBefore)action).getStartIndex())) {
