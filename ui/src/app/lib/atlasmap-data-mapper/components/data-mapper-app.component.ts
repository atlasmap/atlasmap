...
@Component({
  ...
  styleUrls: ['data-mapper-base.component.css',
              'data-mapper-document.component.css',
              'data-mapper-mapping-detail.component.css',
              'data-mapper-mapping-list.component.css',
              'data-mapper-toolbar.component.css'],
})
