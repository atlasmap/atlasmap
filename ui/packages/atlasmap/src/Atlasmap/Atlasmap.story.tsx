...
export const AtlasmapStory: FunctionComponent<IAtlasmapProps> = ({
  allowImport = true,
  allowExport = true,
  allowReset = true,
  allowDelete = true,
      ...
      case "TransformationApproach":
        return (
          <SourceMappingTargetViewStory
            ...
            mappingEvents={mappingEvents}
            targetEvents={targetEvents}
            onMappingNameChange={(mapping: IAtlasmapMapping, name: string) =>
              (mapping.name = name)
            }
      ...
      <CanvasProvider>
        <MainLayout
          ...
          viewToolbar={
            ...
            (activeView !== "ColumnMapper" || !showMappingColumn) &&
            viewToolbar
          }
