...
public class ActionsJsonDeserializer extends JsonDeserializer<Actions> {
    ...
    protected Action processActionJsonToken(JsonParser jsonToken) throws IOException {
        ...
        case "CustomAction": return processCustomActionJsonToken(jsonToken);
        case "GenerateUUID": action = new GenerateUUID(); return action;
        case "Lowercase": action = new Lowercase(); return action;
        case "PadStringLeft": return processPadStringLeftJsonToken(jsonToken);
        case "PadStringRight": return processPadStringRightJsonToken(jsonToken);
    ...
    protected SubString processSubStringJsonToken(JsonParser jsonToken) throws IOException {
        ...
        do {        
            ...
            switch(jsonToken.getCurrentName()) {
            case "startIndex": jsonToken.nextToken(); action.setStartIndex(jsonToken.getIntValue()); break;
            case "endIndex": jsonToken.nextToken(); action.setEndIndex(jsonToken.getIntValue()); break;
            default: break;
            }
    ...
    protected SubStringAfter processSubStringAfterJsonToken(JsonParser jsonToken) throws IOException {
        ...
        do {        
            ...
            case "startIndex": jsonToken.nextToken(); action.setStartIndex(jsonToken.getIntValue()); break;
            case "endIndex": jsonToken.nextToken(); action.setEndIndex(jsonToken.getIntValue()); break;
            case "match": jsonToken.nextToken(); action.setMatch(jsonToken.getValueAsString()); break;
    ...
    protected PadStringLeft processPadStringLeftJsonToken(JsonParser jsonToken) throws IOException {
        ...
        do {        
            ...
            switch(jsonToken.getCurrentName()) {
            case "padCharacter": jsonToken.nextToken(); action.setPadCharacter(jsonToken.getValueAsString()); break;
            case "padCount": jsonToken.nextToken(); action.setPadCount(jsonToken.getIntValue()); break;
            default: break;
            }
    ...
    protected CurrentDate processCurrentDateJsonToken(JsonParser jsonToken) throws IOException {
        ...
        do {        
            ...
            switch(jsonToken.getCurrentName()) {
            case "dateFormat": jsonToken.nextToken(); action.setDateFormat(jsonToken.getValueAsString()); break;
            default: break;
            }
    ...
    protected CustomAction processCustomActionJsonToken(JsonParser jsonToken) throws IOException {
        ...
        do {        
            ...
            switch(jsonToken.getCurrentName()) {
            case "className": jsonToken.nextToken(); action.setClassName(jsonToken.getValueAsString()); break;
            case "methodName": jsonToken.nextToken(); action.setClassName(jsonToken.getValueAsString()); break;
            default: break;
            }
