...
image:images/magnifying-glass.png[Magnifying Glass] and entering
...
click image:images/EditorSettings.png[Editor settings] and select
...
mapping, select it.
+
Click image:images/grid.png[Grid] again to display the data field
panels.
