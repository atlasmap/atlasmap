...
__optional__|string
|**multiplicity** +
__optional__|enum (ONE_TO_ONE, ONE_TO_MANY, MANY_TO_ONE, ZERO_TO_ONE)
|**name** +
__optional__|string
|**parameters** +
...
[[_atlas-service-core-formulaexpression]]
=== FormulaExpression
...
__optional__|string
|**formulaExpression** +
__optional__|<<_atlas-service-core-formulaexpression,FormulaExpression>>
|**id** +
__optional__|string
|**inputField** +
__optional__|< <<_atlas-service-core-field,Field>> > array
