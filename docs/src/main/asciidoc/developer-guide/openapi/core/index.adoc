...
Retrieves a list of available expression functions


// markup not found, no include::{specDir}functions/GET/spec.adoc[opts=optional]
...
| 200
| Return alist of function details
|  <<FunctionDetails>>
...
// markup not found, no include::{snippetDir}functions/GET/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}functions/GET/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :functions/GET/GET.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}functions/GET/implementation.adoc[opts=optional]
