...
`DELETE /all/{mappingDefinitionId}`

Delete all

===== Description

Delete all user-defined library JAR files, documents and mapping projects


// markup not found, no include::{specDir}all/\{mappingDefinitionId\}/DELETE/spec.adoc[opts=optional]
...
| 200
| All user-defined libarary JARs,documents and mapping projects were deleted successfully
|  <<>>


| 204
| Unable to delete all user-defined JAR files, documents and mapping projects
|  <<>>
...
// markup not found, no include::{snippetDir}all/\{mappingDefinitionId\}/DELETE/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}all/\{mappingDefinitionId\}/DELETE/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :all/{mappingDefinitionId}/DELETE/DELETE.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}all/\{mappingDefinitionId\}/DELETE/implementation.adoc[opts=optional]
...
// markup not found, no include::{specDir}all-documents/DELETE/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}all-documents/DELETE/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}all-documents/DELETE/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :all-documents/DELETE/DELETE.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}all-documents/DELETE/implementation.adoc[opts=optional]
