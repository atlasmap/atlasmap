...
// markup not found, no include::{specDir}java/mavenclasspath/POST/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}java/mavenclasspath/POST/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}java/mavenclasspath/POST/http-response.adoc[opts=optional]
...
// markup not found, no include::{specDir}java/mavenclasspath/POST/implementation.adoc[opts=optional]
...
// markup not found, no include::{specDir}java/class/GET/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}java/class/GET/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}java/class/GET/http-response.adoc[opts=optional]
...
// markup not found, no include::{specDir}java/class/GET/implementation.adoc[opts=optional]
