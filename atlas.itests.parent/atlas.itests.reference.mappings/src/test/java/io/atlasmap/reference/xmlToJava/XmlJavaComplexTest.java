...
public class XmlJavaComplexTest {
    ...
    public void testProcessXmlJavaComplexOrderAutodetectAttribute() throws Exception {
        ...
        String sourceXml = XmlTestUtil.loadXmlStringFromFile("src/test/resources/xmlToJava/atlas-xml-complex-order-autodetect-attribute.xml");
    ...
    public void testProcessXmlJavaComplexOrderAutodetectAttributeNS() throws Exception {
        ...
        AtlasSession session = context.createSession();
        String sourceXml = XmlTestUtil.loadXmlStringFromFile("src/test/resources/xmlToJava/atlas-xml-complex-order-autodetect-attribute-ns.xml");
        session.setInput(sourceXml);
        context.process(session);
    ...
    public void testProcessXmlJavaComplexOrderAutodetectElement() throws Exception {
        ...
        AtlasSession session = context.createSession();
        String sourceXml = XmlTestUtil.loadXmlStringFromFile("src/test/resources/xmlToJava/atlas-xml-complex-order-autodetect-element.xml");
        session.setInput(sourceXml);
        context.process(session);
    ...
    public void testProcessXmlJavaComplexOrderAutodetectElementNS() throws Exception {
        ...
        AtlasSession session = context.createSession();
        String sourceXml = XmlTestUtil.loadXmlStringFromFile("src/test/resources/xmlToJava/atlas-xml-complex-order-autodetect-element-ns.xml");
        session.setInput(sourceXml);
        context.process(session);
