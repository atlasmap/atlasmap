...
public class XmlJavaFlatMappingTest {
    ...
    public void testCreateXmlJavaFlatFieldMapping() throws Exception {
        ...
        atlasMappingService.saveMappingAsFile(atlasMapping, new File("src/test/resources/xmlToJava/atlasmapping-flatprimitive.xml"));
    }
    ...
    public void testProcessXmlJavaFlatPrimitiveAttribute() throws Exception {
        ...
        String sourceXml = XmlTestUtil.loadXmlStringFromFile("src/test/resources/xmlToJava/atlas-xml-flatprimitive-attribute.xml");
    ...
    public void testProcessXmlJavaFlatPrimitiveAttributeNS() throws Exception {
        ...
        AtlasSession session = context.createSession();
        String sourceXml = XmlTestUtil.loadXmlStringFromFile("src/test/resources/xmlToJava/atlas-xml-flatprimitive-attribute-ns.xml");
        session.setInput(sourceXml);
        context.process(session);
    ...
    public void testProcessXmlJavaFlatPrimitiveElement() throws Exception {
        ...
        AtlasSession session = context.createSession();
        String sourceXml = XmlTestUtil.loadXmlStringFromFile("src/test/resources/xmlToJava/atlas-xml-flatprimitive-element.xml");
        session.setInput(sourceXml);
        context.process(session);
    ...
    public void testProcessXmlJavaFlatPrimitiveElementNS() throws Exception {
        ...
        AtlasSession session = context.createSession();
        String sourceXml = XmlTestUtil.loadXmlStringFromFile("src/test/resources/xmlToJava/atlas-xml-flatprimitive-element-ns.xml");
        session.setInput(sourceXml);
        context.process(session);
    ...
    public void testProcessXmlJavaBoxedFlatMappingPrimitiveAttribute() throws Exception {
        ...
        AtlasSession session = context.createSession();
        String sourceXml = XmlTestUtil.loadXmlStringFromFile("src/test/resources/xmlToJava/atlas-xml-boxedflatprimitive-attribute.xml");
        session.setInput(sourceXml);
        context.process(session);
    ...
    public void testProcessXmlJavaBoxedFlatMappingPrimitiveAttributeNS() throws Exception {
        ...
        AtlasSession session = context.createSession();
        String sourceXml = XmlTestUtil.loadXmlStringFromFile("src/test/resources/xmlToJava/atlas-xml-boxedflatprimitive-attribute-ns.xml");
        session.setInput(sourceXml);
        context.process(session);
    ...
    public void testProcessXmlJavaBoxedFlatMappingPrimitiveElement() throws Exception {
        ...
        AtlasSession session = context.createSession();
        String sourceXml = XmlTestUtil.loadXmlStringFromFile("src/test/resources/xmlToJava/atlas-xml-boxedflatprimitive-element.xml");
        session.setInput(sourceXml);
        context.process(session);
    ...
    public void testProcessXmlJavaBoxedFlatMappingPrimitiveElementNS() throws Exception {
        ...
        AtlasSession session = context.createSession();
        String sourceXml = XmlTestUtil.loadXmlStringFromFile("src/test/resources/xmlToJava/atlas-xml-boxedflatprimitive-element-ns.xml");
        session.setInput(sourceXml);
        context.process(session);
