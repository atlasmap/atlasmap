...
const CanvasViewFieldsContext = createContext<ICanvasViewFieldsContext | undefined>(undefined);

export const CanvasViewFieldsProvider: FunctionComponent = ({
  children
}) => {
  ...
  return (
    <CanvasViewFieldsContext.Provider value={{
      addField,
      removeField,
      requireVisible
    }}>
