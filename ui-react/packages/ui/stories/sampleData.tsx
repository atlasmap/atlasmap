                  ...
                  "xmlFields" : {
                    "xmlField" : [ {
                      ...
                      "xmlFields" : {
                        "xmlField" : [ {
                          "jsonType" : "io.atlasmap.xml.v2.XmlField",
                          "path" : "/tns:request/tns:body/Pet/Category/id",
                          "fieldType" : "DECIMAL",
                          "restrictions" : {
                            "restriction" : [ ]
                          },
                          ...
                          "jsonType" : "io.atlasmap.xml.v2.XmlField",
                          "path" : "/tns:request/tns:body/Pet/Category/name",
                          "fieldType" : "STRING",
                          "restrictions" : {
                            "restriction" : [ ]
                          },
                      ...
                      "xmlFields" : {
                        "xmlField" : [ {
                          "jsonType" : "io.atlasmap.xml.v2.XmlField",
                          "path" : "/tns:request/tns:body/Pet/photoUrl/photoUrl",
                          "fieldType" : "STRING",
                          "restrictions" : {
                            "restriction" : [ ]
                          },
                      ...
                      "xmlFields" : {
                        "xmlField" : [ {
                          ...
                          "xmlFields" : {
                            "xmlField" : [ {
                              "jsonType" : "io.atlasmap.xml.v2.XmlField",
                              "path" : "/tns:request/tns:body/Pet/tag/Tag/id",
                              "fieldType" : "DECIMAL",
                              "restrictions" : {
                                "restriction" : [ ]
                              },
                              ...
                              "jsonType" : "io.atlasmap.xml.v2.XmlField",
                              "path" : "/tns:request/tns:body/Pet/tag/Tag/name",
                              "fieldType" : "STRING",
                              "restrictions" : {
                                "restriction" : [ ]
                              },
    ...
    "xmlDocument" : {
      ...
      "fields" : {
        "field" : [ {
          ...
          "fieldType" : "COMPLEX",
          "name" : "ns:XmlOE",
          "typeName" : "http://atlasmap.io/xml/test/v2 atlas-xml-test-model-v2.xsd ",
          "xmlFields" : {
            "xmlField" : [ {
              "jsonType" : "io.atlasmap.xml.v2.XmlField",
              "value" : "ns:orderId",
...
export const mappings = [
  {
    id: 'a',
    sourceFields: ['JSONSchemaSource-/order/address/city', 'JSONSchemaSource-/order/address/state'],
    targetFields: ['XMLInstanceSource-/ns:XmlOE/ns:Address/ns:addressLine1'],
  },
  {
    id: 'b',
    sourceFields: ['JSONInstanceSource-/primitives/numberPrimitive'],
    targetFields: ['io.paul.Bicycle-/cadence', 'io.paul.Bicycle-/gear', 'io.paul.Bicycle-/speed'],
  },
  {
    id: 'c',
    sourceFields: ['JSONInstanceSource-/primitives/stringPrimitive', 'JSONInstanceSource-/order/orderId', 'JSONSchemaSource-/primitives/stringPrimitive'],
    targetFields: ['io.paul.Bicycle-/serialId'],
  },
];