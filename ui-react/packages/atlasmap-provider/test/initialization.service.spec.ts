...
describe('InitializationService', () => {
  ...
  it('should load document definitions', done => {
    inject([InitializationService], (service: InitializationService) => {
      ...
      sourceJson.inspectionResult = jasmine
        .getFixtures()
        .read('atlasmap-inspection-mock-json-schema.json');
      ...
      sourceXml.inspectionResult = jasmine
        .getFixtures()
        .read('atlasmap-inspection-mock-xml-instance-1.json');
      ...
      targetJson.inspectionResult = jasmine
        .getFixtures()
        .read('atlasmap-inspection-mock-json-instance.json');
      ...
      targetXml.inspectionResult = jasmine
        .getFixtures()
        .read('atlasmap-inspection-mock-xml-schema-1.json');
  ...
  it('should load mapping definition', done => {
    inject([InitializationService], (service: InitializationService) => {
      ...
      cfg.preloadedFieldActionMetadata = fixtures.read(
        'atlasmap-field-action.json'
      );
      ...
      source.inspectionResult = fixtures.read(
        'atlasmap-inspection-old-action-source.json'
      );
      ...
      target.inspectionResult = fixtures.read(
        'atlasmap-inspection-old-action-target.json'
      );
      ...
      service.systemInitialized$.subscribe(() => {
        ...
        expect(cfg.errorService.getErrors().length).toEqual(
          0,
          cfg.errorService.getErrors()
        );
        done();
      });
