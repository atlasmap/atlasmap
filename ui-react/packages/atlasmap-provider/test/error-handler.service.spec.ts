...
describe('ErrorHandlerService', () => {
  ...
  it('should support addError() and removeError()', inject(
    [ErrorHandlerService],
  ...
  it('should support clearAllErrors()', inject(
    [ErrorHandlerService],
    (service: ErrorHandlerService) => {
      expect(service.getErrors().length).toEqual(0);
  ...
  it('should support clearPreviewErrors()', inject(
    [ErrorHandlerService],
    (service: ErrorHandlerService) => {
      expect(service.getErrors().length).toEqual(0);
      service.addError(
  ...
  it('should support clearValidationErrors()', inject(
    [ErrorHandlerService],
    (service: ErrorHandlerService) => {
      expect(service.getErrors().length).toEqual(0);
      service.addError(
  ...
  it('should support clearFieldErrors()', inject(
    [ErrorHandlerService],
    (service: ErrorHandlerService) => {
      expect(service.getErrors().length).toEqual(0);
      service.addError(
